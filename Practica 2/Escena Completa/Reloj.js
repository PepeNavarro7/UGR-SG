...
////////////////////////////////////////////RELOJ//////////////////////////////////////////////////////////
  ...
  recibeClic ( meshConcreto ) {
    ...
    meshConcreto.rotation.y -=  this.tam_marca;
    
    if(meshConcreto==this.aguja){
      if(this.contador==11){
        this.contador=0;
      }
      else{
    ...
    if(meshConcreto==this.aguja_hora){
      if(this.contador_hora==11){
        this.contador_hora=0;
      }
      else{
        this.contador_hora++;
       ...
       //   console.log("A: "+this.contador+" B: "+this.contador_hora)
  }
  
  compruebaPuzle(){
     if(this.contador_hora == 2 && this.contador == 7){
       return true;
     }
     else{
       return false;
