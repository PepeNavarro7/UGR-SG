...
class RelojPendulo extends THREE.Object3D {
  ...
  crearPendulo(){
    ...
    const mesh1 = new THREE.Mesh( circGeom, this.mat_dorado ) ;

    const boxGeom = new THREE.BoxGeometry(0.2,4.0,0.5);    
    const mesh2 = new THREE.Mesh( boxGeom, this.mat_dorado ) ;
  ...
  animacionAgujas(){
    // Este método finalmente no se utiliza, ya que las agujas se encuentran quietas para el puzle
